...
def parse_command_line(parser=None, args=None):
    ...
    parser.add_argument(
        "-lambda_o", type=float, default=0.0, help="coefficient of offroad cost"
    )
    parser.add_argument(
        "-lambda_g", type=float, default=1.0, help="coefficient of goal cost"
    )
    parser.add_argument(
    ...
    parser.add_argument(
        ...
        type=int,
        default=-1,
        help="goal rollout length, -1 means equal to npred",
    )
