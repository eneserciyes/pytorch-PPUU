...
from ppuu.maps.map_i80 import I80, I80Car, colours
...
class US101(I80):
    ...
    def __init__(self, **kwargs):
        ...
        self.screen_size = (
            125 * self.LANE_W,
            self.nb_lanes * self.LANE_W + 4 * self.LANE_W,
        )
        # self.photos = (
        ...
        self._t_slot = None
        self._black_list = {
            self._time_slots[0]: {2691, 2809, 2820, 2871, 2851, 2873},
            self._time_slots[1]: {649, 806, 1690, 1725, 1734, 1773, 1949, 1877},
            self._time_slots[2]: {
                183,
                329,
                791,
    ...
    def _draw_lanes(self, surface, mode="human", offset=0):
        ...
        if mode == "human":
            ...
            draw_line(
                s, w, (22 * LANE_W, bottom + LANE_W), (90 * LANE_W, bottom + LANE_W), 3
            )
        ...
        if mode == "machine":
            ...
            draw_line(
                s, w, (0, lanes[-1]["max"] + m), (sw + 2 * m, lanes[-1]["max"] + m), 1
            )
            ...
            draw_line(
                s, w, (22 * LANE_W, bottom + LANE_W), (90 * LANE_W, bottom + LANE_W), 1
            )
