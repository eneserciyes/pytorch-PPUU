...
from ppuu.maps.map_lanker import LankerCar
from ppuu.maps.map_i80 import I80
...
class Peachtree(I80):
    ...
    def __init__(self, **kwargs):
        ...
        self.offset = (
            None  # data is fucked up here, fixing it in the custom reset method
        )
    ...
    def _draw_lanes(self, surface, mode="human", offset=0):
        ...
        if mode == "human":
            ...
            if mode not in self._lane_surfaces:
                self._lane_surfaces[mode] = pygame.image.load(
                    "Peachtree/lanes_human.png"
                )
